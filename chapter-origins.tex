...
\subesection{Cross Wavelet Spectra}
...
\caption[Wavelet power spectrum for 5 year mean PDO index from UKESM]{As figure 8 for the Sep-Nov PDO index smoothed with a 5 year window. \textbf{a}: PDO time series and associated wavelet power spectrum. \textbf{b}: Cross power spectrum between PDO and $SSW_{5yr}$.}
...
\begin{center}
\begin{figure}[h!]
\noindent\includegraphics[width = 1.2\linewidth]{Figures/Figures-origins/QBO_levels.png}
...
\begin{figure}[h!]
    \begin{center}
    \includegraphics[width = 1.2\linewidth]{Figures/Figures-origins/QBO_levels_amp.png}
