...
There exists a large body of literature examining the nature of the QBO and ,of particular relevance for this study, how they couple to variability of the polar vortex and their representation in GCMs. 

An association between the phase of the QBO and the strength of the polar vortex was first proposed in \cite{HoltonJamesRTan1980} and \cite{Holton1982}, in which it was observed that the polar vortex exhibited a strengthening when the QBO near the 50hPa level was in its westerly phase compared to its easterly. This link has been verified in subsequent studies with more comprehensive observations as well as in modelling studies using GCMs including the MetOffice Hadley Centre Model 2 (HadGEM2), the predecessor of the models considered in this study \citep{Baldwin1991,Pascoe2005,Lu2008,Watson2014}. 

A number of physical mechanisms have been proposed to account for the observed coupling between the QBO and the vortex. Most notable is the hypothesis that during westerly phases, the zero wind line (the latitude at various heights at which the NH mid latitude winter westerlies meet the equatorial winds) is shifted equator-wards \citep{HoltonJamesRTan1980}. This can permit planetary waves to propagate vertically but be diverted equator-wards (according to Charney-Drazin) and decrease their dissipative affect on the vortex. The converse argument could be made for easterly QBO phases when the zero-wind line lies further north and thus the planetary waves are guided more directly towards the vortex. Indications of this effect may manifest in EP-flux divergence at different latitudes for each QBO phase. However, studies which have tested this mechanism show varied results. Some find a significant difference in latitudinal distribution of EP flux divergence between QBO phases \citep{Hamilton} while others propose caveats such as the mechanism only taking effect during certain winter months \citep{Hu2002,Gray2004} and the effect competing with other possible phenomena such as the meridional circulation associated with QBO phases \citep{Garfinkel12}. \cite{Lu14} examines the HT effect further and proposes the mechanism is due to the formation of a mid-latitude waveguide which influences both the vertical and meridional propagation of waves (similar to above). However, this work also shows that the strength of this effect is transient in nature, the coupling is weakened if a broader and stronger vortex is present in NH winter due to divergence of wave activity generated by eddies within the vortex itself. This diverts wave activity equatorwards, an opposite driving mechanism to that of Holton-Tan. These competing processes temporarily reduces the influence of the QBO on the vortex.
