...
\centering
    ...
    \caption[Equatorial ZMZW and associated Fourier power spectrum.]{Equatorial ZMZW (top) and associated Fourier power spectrum (bottom) from a 30 year sample from the ERA-Interim dataset between 1979 and 2009. A 30 year sample of data is provided to demonstrate the stalling of descending QBO phases.}
...
\centering
    ...
    \caption[Time-height composites of the NAM about anomalous vortex events in the ERA40 dataset from \cite{baldwinStratospheric2001}.]{Time-height composites of the NAM about anomalous weak (A) and strong (B) vortex events in the ERA40 dataset. Events are defined when NAM values cross -3.0 (weak) and +1.5 (strong). Coloured contours are spaced at 0.25 NAM intervals while white contours are spaced at 0.5. Only NAM values with a magnitude greater than 0.25 are shown. Vertical lines denote the central date of the vortex event and horizontal lines the approximate height of the tropopause. Figure from \cite{baldwinStratospheric2001}.}  
...
\subsection{Ocean Variability}
as well as the influence of vortex variations on tropospheric and surface variability, there is also some discussion of coupling with modes of ocean variability. 

One of the primary modes of variability in ocean circulation is the Atlantic Meridional Overturning Circulation (AMOC), a northward transfer of warm, saline water that occurs in the upper levels (top 1km) of the Atlantic Ocean accompanied by a corresponding return flow of southward transport and lower depths \citep{kuhlbrodtDriving2007, xuIntraseasonal2014}. The strength of this northward transfer varies significantly on decadal-centennial timescales \citep{delworthInterdecadal1993, biastochCauses2008a, tullochExploring2012, menaryMultimodel2012} and is a key driver of North American and European climate \citep{knightSignature2005, delworthObserved2000, friersonContribution2013, frankignoulInfluence2013}. It has been shown to influence a diverse range of features such as European summertime temperatures \citep{suttonAtlantic2005}, biogeochemical conditions in the northwest Atlantic \citep{lavoieProjections2019} as well a abrupt climate shifts in paleoclimate records \citep{alleyWally2007a, chengIce2009a}. The drivers of AMOC variability have been studied extensively in both observations and modelling studies and the proposed mechanisms are numerous: On intra-annual to inter-annual timescales, variability in the AMOC is suggested to be closely associated with wind variations over the North Atlantic region. This takes the form of Ekman-transport anomalies or wind stress curl forcing \citep{wangCharacteristic2019, mccarthyObserved2012, mielkeObserved2013, yangLocal2015}. On inter-annual to decadal timescales, the AMOC is widely proposed to be heavily influenced by buoyancy anomalies in the subpolar region, particularly in the Labrador sea \citep{delworthInterdecadal1993, medhaugMechanisms2012} Roberts et al., 2013a). This mechanism is linked to variability in mixed layer depth, the layer in which salinity, temperature and density and generally vertically uniform (xxxx), and occurrence of deep convection anomalies over the same region particularly in NH winter \citep{boningDecadal2006a, biastochCauses2008a, robsonCauses2012, wangVariability2015}.

- some sentences on recent AMOC trends here

Other work analyses interactions between the vortex and the AMOC. \cite{reichlerStratospheric2012} examine the response in the AMOC to strong and weak polar vortex events and show a response in the AMOC which varies with lag time after SSWs on decadal timescales. The work proposes that variability in SSW event occurrence contributes significantly to similar timescale variations in the AMOC leading to oscillatory responses. The primary mechanism suggested for this association is a pathway involving alterations of wind stress and Ocean-Atmosphere heat flux anomalies in the west Atlantic caused by NAO patterns following vortex events. The effect is found in both a single model and to some extent in a suite of CMIP5 models although the AMOC's oscillatory responses damp away approximately 15 years following extreme vortex anomalies. The connection between NAO and the AMOC is supported by a range of work \citep{visbeckOcean1998, delworthImplications2000, delworthMultidecadal2000, edenMechanism2001}. Most recently \cite{delworthImpact2016} uses a set of idealised GCM experiments which impose a perpetual Ocean-Atmosphere heat flux pattern associated with different NAO phases and finds significantly different AMOC mean states depending on the imposed pattern. Additionally, \cite{haaseImportance2018} analyses the impact of SSW events on deep convection in the North Atlantic via alterations of the NAO. The study finds a shallow anomaly in Labrador sea mixed layer depth after an SSW event which has in turn been proposed a driver of the AMOC in modelling studies \citep{edenMechanism2001, edenNorth2001} and observations \citep{latifPerspective2011}. Overall, interactions between the vortex and the AMOC appear in GCM studies as well as 


\section{Multi-decadal Climate Variability}
\label{sec:multi-decadal_background}
In the majority of studies covered thus far, vortex variability and its interactions the the wider climate system are considered within each NH winter (so called in-season phenomena). However, there is a growing body of evidence in support of various modes of multi-decadal variations in the climate as well a interactions between such modes. As a result, there is also limited evidence that the vortex could exhibit variability on much longer timescales than is examined in the majority of work although this is not well understood. 
...
There is some evidence of vortex variations with periods longer than a year in the observational record. In reanalysis datasets, SSWs occur at an average rate of 0.6 events/winter but this varies markedly over the record \citep{Butler2015} suggesting the possibility of variability on much longer timescales. For example, observational studies have noted a hiatus in the 1990s when very few major SSW events occurred \citep{Butler2015,Pawson1999,Shindell1999} while, in contrast, the early 21st century displayed a remarkable number of consecutive winters containing SSW events \citep{Manney2005}. 
 ...
 are most often found in the Ocean due to the high degree of thermal inertia. Such modes can subsequently project onto surface of atmospheric variability
    - AMV
    - PDO

- MD variations in the atmosphere - vortex as well as QBO (pre made text)
