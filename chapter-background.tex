...
While the polar vortex is a stratospheric phenomenon, variability in its strength is a key component in two way stratosphere-troposphere coupling. 

\subsection{Upward Influence on the Vortex}
Vortex variability has been closely associated with variations in winter surface climate that can determine the strength of mid-latitude tropospheric wave driving.
